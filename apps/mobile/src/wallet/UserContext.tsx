...
// Path depth only: source was context/UserContext.tsx (one level below the app root);
// this file now lives at apps/mobile/src/wallet/UserContext.tsx (two levels below
// apps/mobile/package.json), so the relative path gained a segment. Same file, same role.
