...
/**
 * Wraps a Swift `(_ frameBase64: String) -> Void` as a class.
...
public final class Func_void_std__string {
  ...
  private let closure: (_ frameBase64: String) -> Void

  public init(_ closure: @escaping (_ frameBase64: String) -> Void) {
    self.closure = closure
  }

  @inline(__always)
  public func call(frameBase64: std.string) -> Void {
    self.closure(String(frameBase64))
  }
