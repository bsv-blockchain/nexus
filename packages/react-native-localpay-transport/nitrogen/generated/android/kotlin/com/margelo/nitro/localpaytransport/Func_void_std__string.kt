...
/**
 * Represents the JavaScript callback `(frameBase64: string) => void`.
...
fun interface Func_void_std__string: (String) -> Unit {
  ...
  @DoNotStrip
  @Keep
  override fun invoke(frameBase64: String): Unit
}
...
class Func_void_std__string_cxx: Func_void_std__string {
  ...
  @Keep
  override fun invoke(frameBase64: String): Unit
    = invoke_cxx(frameBase64)

  @FastNative
  private external fun invoke_cxx(frameBase64: String): Unit
}
...
class Func_void_std__string_java(private val function: (String) -> Unit): Func_void_std__string {
  ...
  @Keep
  override fun invoke(frameBase64: String): Unit {
    return this.function(frameBase64)
  }
}
